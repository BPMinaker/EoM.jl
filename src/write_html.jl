...
function write_html(
            ...
            for j = 1:nin
                ...
                if findnext(ss .== n, 1) != nothing
                    ...
                    if nvpts > 1
                        ...
                        println(
                            output_f,
                            "<iframe src=\"$path\" width=625 height=325 frameborder=0 ></iframe>",
                        )
                        println(output_f, "")
                    end
                end
    ...
    if nin * nout > 0 && nin * nout < 16 && length(bode) > 0
        ...
        if length(l) == 1
            for i = 1:nin
                ...
                println(
                    output_f,
                    "<iframe src=\"$path\" width=625 height=475 frameborder=0></iframe>",
                )
                println(output_f, "")
            end
        else
    ...
    for i = 1:n
        ...
        println(
            output_f,
            "<iframe src=\"$path\" width=625 height=425 frameborder=0></iframe>",
        )
        println(output_f, "")
    end
